...
import { MedicationListItem } from "../../components/MedicationListItem/MedicationListItem";
import { Button, CustomModal } from "@medication-intake-tracker/shared";
...
const MedicationList = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="medication-list__add-button-container"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.5 }}
      >
        <Button onClick={openModal}>Add Medication</Button>
      </motion.div>
      <CustomModal
